...
class ClientSocket(Socket):
    ...
    def send_s(self, data:"str")->"int":
        ...
        msgJson:"str" = dumps(obj={"msg": data}, ensure_ascii=False)
        msgToSend:"Union[str,bytes]" = SecurityManager.encrypt(text=msgJson+Socket.END_MSG, key=self.key, encoded=True)
